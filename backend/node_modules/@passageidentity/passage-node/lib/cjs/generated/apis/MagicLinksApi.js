...
exports.MagicLinksApi = void 0;
const runtime = __importStar(require("../runtime"));
const index_1 = require("../models/index");
/**
 *
 */
class MagicLinksApi extends runtime.BaseAPI {
    /**
     * Create magic link for a user.
     * Create Embeddable Magic Link
     */
    createMagicLinkRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.request({
                ...
                body: (0, index_1.CreateMagicLinkRequestToJSON)(requestParameters.createMagicLinkRequest),
            }, initOverrides);
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.MagicLinkResponseFromJSON)(jsonValue));
        });
    }
    /**
     * Create magic link for a user.
     * Create Embeddable Magic Link
     */
    createMagicLink(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.createMagicLinkRaw(requestParameters, initOverrides);
            return yield response.value();
        });
    }
}
exports.MagicLinksApi = MagicLinksApi;
