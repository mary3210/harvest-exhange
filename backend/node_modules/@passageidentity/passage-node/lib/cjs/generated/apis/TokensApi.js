...
class TokensApi extends runtime.BaseAPI {
     ...
     */
    revokeUserRefreshTokensRaw(requestParameters, initOverrides) {
     ...
     * Revokes refresh tokens
     */
    revokeUserRefreshTokens(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.revokeUserRefreshTokensRaw(requestParameters, initOverrides);
        });
    }
}
