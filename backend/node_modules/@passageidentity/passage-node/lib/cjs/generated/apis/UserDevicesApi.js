...
exports.UserDevicesApi = void 0;
const runtime = __importStar(require("../runtime"));
const index_1 = require("../models/index");
/**
 *
 */
class UserDevicesApi extends runtime.BaseAPI {
    /**
    ...
    listUserDevicesRaw(requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new runtime.JSONApiResponse(response, (jsonValue) => (0, index_1.ListDevicesResponseFromJSON)(jsonValue));
        });
    }
    /**
     * List user devices.
...
exports.UserDevicesApi = UserDevicesApi;
