...
function AppInfoFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'auth_methods': (0, AuthMethods_1.AuthMethodsFromJSON)(json['auth_methods']),
        ...
        'light_logo_url': !(0, runtime_1.exists)(json, 'light_logo_url') ? undefined : json['light_logo_url'],
        'dark_logo_url': !(0, runtime_1.exists)(json, 'dark_logo_url') ? undefined : json['dark_logo_url'],
        'name': json['name'],
        'hosted': json['hosted'],
        ...
        'element_customization_dark': (0, ElementCustomization_1.ElementCustomizationFromJSON)(json['element_customization_dark']),
    };
}
...
function AppInfoToJSON(value) {
    ...
    return {
        ...
        'auth_methods': (0, AuthMethods_1.AuthMethodsToJSON)(value.auth_methods),
        ...
        'element_customization_dark': (0, ElementCustomization_1.ElementCustomizationToJSON)(value.element_customization_dark),
    };
}
