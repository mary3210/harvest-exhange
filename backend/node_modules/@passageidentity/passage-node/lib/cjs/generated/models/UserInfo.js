...
const UserSocialConnections_1 = require("./UserSocialConnections");
...
function UserInfoFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'social_connections': (0, UserSocialConnections_1.UserSocialConnectionsFromJSON)(json['social_connections']),
        'status': (0, UserStatus_1.UserStatusFromJSON)(json['status']),
        ...
        'webauthn_types': (json['webauthn_types'].map(WebAuthnType_1.WebAuthnTypeFromJSON)),
    };
}
...
function UserInfoToJSON(value) {
    ...
    return {
        ...
        'social_connections': (0, UserSocialConnections_1.UserSocialConnectionsToJSON)(value.social_connections),
        'status': (0, UserStatus_1.UserStatusToJSON)(value.status),
        'updated_at': (value.updated_at.toISOString()),
        'user_metadata': value.user_metadata,
        'webauthn': value.webauthn,
        'webauthn_devices': (value.webauthn_devices.map(WebAuthnDevices_1.WebAuthnDevicesToJSON)),
        'webauthn_types': (value.webauthn_types.map(WebAuthnType_1.WebAuthnTypeToJSON)),
    };
}
