 ...
 */
export function instanceOfMagicLinkAuthMethod(value) {
    let isInstance = true;
...
export function MagicLinkAuthMethodFromJSON(json) {
    return MagicLinkAuthMethodFromJSONTyped(json, false);
}
export function MagicLinkAuthMethodFromJSONTyped(json, ignoreDiscriminator) {
...
export function MagicLinkAuthMethodToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
