 ...
 */
import { WebAuthnIconsFromJSON, WebAuthnIconsToJSON, } from './WebAuthnIcons';
 ...
 */
export function instanceOfWebAuthnDevices(value) {
    let isInstance = true;
...
export function WebAuthnDevicesFromJSON(json) {
    return WebAuthnDevicesFromJSONTyped(json, false);
}
export function WebAuthnDevicesFromJSONTyped(json, ignoreDiscriminator) {
...
export function WebAuthnDevicesToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
