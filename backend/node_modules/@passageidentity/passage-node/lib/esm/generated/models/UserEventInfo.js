 ...
 */
export function instanceOfUserEventInfo(value) {
    let isInstance = true;
...
export function UserEventInfoFromJSON(json) {
    return UserEventInfoFromJSONTyped(json, false);
}
export function UserEventInfoFromJSONTyped(json, ignoreDiscriminator) {
...
export function UserEventInfoToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
