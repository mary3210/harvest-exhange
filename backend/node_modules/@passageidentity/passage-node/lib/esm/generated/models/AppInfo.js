...
import { AuthMethodsFromJSON, AuthMethodsToJSON, } from './AuthMethods';
import { ElementCustomizationFromJSON, ElementCustomizationToJSON, } from './ElementCustomization';
import { LayoutsFromJSON, LayoutsToJSON, } from './Layouts';
import { TechnologiesFromJSON, TechnologiesToJSON, } from './Technologies';
import { UserMetadataFieldFromJSON, UserMetadataFieldToJSON, } from './UserMetadataField';
/**
 * @export
 */
 ...
 */
export function instanceOfAppInfo(value) {
    let isInstance = true;
...
export function AppInfoFromJSON(json) {
    return AppInfoFromJSONTyped(json, false);
}
export function AppInfoFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'type': json['type'],
        'user_metadata_schema': (json['user_metadata_schema'].map(UserMetadataFieldFromJSON)),
        'technologies': (json['technologies'].map(TechnologiesFromJSON)),
...
export function AppInfoToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'type': value.type,
        'user_metadata_schema': (value.user_metadata_schema.map(UserMetadataFieldToJSON)),
        'technologies': (value.technologies.map(TechnologiesToJSON)),
