...
import { MagicLinkChannelFromJSON, MagicLinkChannelToJSON, } from './MagicLinkChannel';
import { MagicLinkTypeFromJSON, MagicLinkTypeToJSON, } from './MagicLinkType';
/**
 * Check if a given object implements the CreateMagicLinkRequest interface.
 */
export function instanceOfCreateMagicLinkRequest(value) {
    let isInstance = true;
...
export function CreateMagicLinkRequestFromJSON(json) {
    return CreateMagicLinkRequestFromJSONTyped(json, false);
}
export function CreateMagicLinkRequestFromJSONTyped(json, ignoreDiscriminator) {
...
export function CreateMagicLinkRequestToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
