...
import { FontFamilyFromJSON, FontFamilyToJSON, } from './FontFamily';
/**
 * Check if a given object implements the ElementCustomization interface.
 */
export function instanceOfElementCustomization(value) {
    let isInstance = true;
    return isInstance;
}
export function ElementCustomizationFromJSON(json) {
    return ElementCustomizationFromJSONTyped(json, false);
}
export function ElementCustomizationFromJSONTyped(json, ignoreDiscriminator) {
...
export function ElementCustomizationToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
