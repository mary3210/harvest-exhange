 ...
 */
export function instanceOfModel404Error(value) {
    let isInstance = true;
    isInstance = isInstance && "code" in value;
    isInstance = isInstance && "error" in value;
    return isInstance;
}
export function Model404ErrorFromJSON(json) {
    return Model404ErrorFromJSONTyped(json, false);
}
export function Model404ErrorFromJSONTyped(json, ignoreDiscriminator) {
...
export function Model404ErrorToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
