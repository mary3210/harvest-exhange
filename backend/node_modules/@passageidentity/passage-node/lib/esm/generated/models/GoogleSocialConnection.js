 ...
 */
export function instanceOfGoogleSocialConnection(value) {
    let isInstance = true;
...
export function GoogleSocialConnectionFromJSON(json) {
    return GoogleSocialConnectionFromJSONTyped(json, false);
}
export function GoogleSocialConnectionFromJSONTyped(json, ignoreDiscriminator) {
...
export function GoogleSocialConnectionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
