...
import { TtlDisplayUnitFromJSON, TtlDisplayUnitToJSON, } from './TtlDisplayUnit';
/**
 * Check if a given object implements the UpdateMagicLinkAuthMethod interface.
 */
export function instanceOfUpdateMagicLinkAuthMethod(value) {
    let isInstance = true;
    return isInstance;
}
export function UpdateMagicLinkAuthMethodFromJSON(json) {
    return UpdateMagicLinkAuthMethodFromJSONTyped(json, false);
}
export function UpdateMagicLinkAuthMethodFromJSONTyped(json, ignoreDiscriminator) {
...
export function UpdateMagicLinkAuthMethodToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
